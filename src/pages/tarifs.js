  ...
  <Layout>
    ...
    <div className="check-list m-3 p-2">
        ...
        <div className="check-item py-2">
          ...
          <p>
            <strong>Satisfait ou remboursé :</strong> <br/> si notre solution ne vous satisfait pas,
            nous vous remboursons intégralement les 4 premiers mois.
          </p>
        </div>
        <div className="check-item py-2">
          <i className="checked"></i>
          <p>
            <strong>Offre de parrainage :</strong> <br/>recommandez-nous auprès de vos confrères ou
            autre dirigeant d'entreprise et bénéficiez d'un mois de
      ...
      <div className="bundle p-3 mx-5">
        ...
        <div className="price-check-list px-1 ">
